                ...
                <div class="row g-3">
                    <div class="col-lg">
                        <div class="row g-4 justify-content-center">
                            <!-- perulangan menampilkan item -->
                            @foreach ($items as $item)
                            <div class="col-md-6 col-lg-6 col-xl-4">
                                <div class="rounded position-relative fruite-item">
                                    <div class="fruite-img">
                                        <!-- menampilkan gambar item, jika tidak ada gambar dari internet, maka akan menampilkan gambar default -->
                                        <img src="{{ asset('img_item_upload/'. $item->img) }}" class="img-fluid w-100 rounded-top" alt="" onerror="this.onerror=null;this.src='{{  $item->img }}';">
                                    </div>
                                    <!-- menampilkan kategori item , dan merubah warna background sesuai dengan kategori -->
